...
namespace RealEstateDapperUI.ViewComponents.EstateAgent
{
    public class _EstateAgentDashboardStatisticsComponentPartial :ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var response1 = await client1.GetAsync("https://localhost:7195/api/EstateAgentStatistics/ProductCountByEmployeeId?id="+ id);
            ...
            var response2 = await client2.GetAsync("https://localhost:7195/api/EstateAgentStatistics/AllProductCount");
            ...
            var response3 = await client3.GetAsync("https://localhost:7195/api/EstateAgentStatistics/ProductCountByStatusTrue?id=" + id);
            ...
            var response4 = await client4.GetAsync("https://localhost:7195/api/EstateAgentStatistics/ProductCountByStatusFalse?id=" + id);
